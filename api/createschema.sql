...
CREATE TABLE meteorLog (logid TEXT PRIMARY KEY, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP, username TEXT, amount INTEGER, FOREIGN KEY (username) REFERENCES users (username));
