...
CREATE TABLE shop (shopid INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, cost INTEGER, type INTEGER);

CREATE TABLE facts (factid INTEGER PRIMARY KEY AUTOINCREMENT, fact TEXT, category TEXT);